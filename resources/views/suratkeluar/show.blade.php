                ...
                <form>
                    <div class="form-body">
                            ...
                            <div class="col-md-9">
                                <select class="form-control custom-select select2" name="kode_surat" disabled>
                                    @foreach($klasifikasi as $k)
                                        @if($suratkeluar->kode_surat!=null)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="date" class="form-control" name="tanggal_pengiriman" value="{{ $suratkeluar->tanggal_pengiriman }}" placeholder="hh/bb/tttt" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label text-left col-md-3">Media Pengiriman</label>
                            <div class="col-md-9">
                                <select class="form-control custom-select select2" name="media_pengiriman" disabled>
                                    <option value="" {{ $suratkeluar->media_pengiriman == ''? 'selected' : '' }}>==Pilih media pengiriman==</option>
