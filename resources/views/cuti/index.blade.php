                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @endif
                                    @elseif($c->status_level2 == 'Menunggu')
                                    <span class="badge badge-secondary px-2 py-1" style="font-size: 11px; border-radius: 12px; background-color:#dc3545;">Menunggu Persetujuan Atasan</span>
                                    @elseif($c->status_level1 == 'Menunggu')
                                    <span class="badge badge-secondary px-2 py-1" style="font-size: 11px; border-radius: 12px; background-color:#fd7e14;">Menunggu Persetujuan Pimpinan</span>
                                    @endif
                                </td>
                                <td class="text-center">
