                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select name="level" class="form-control @error('level') is-invalid @enderror">
                                    <option value="">-</option>
                                    <option value="1" @if((string) $jabatan->level === '1') selected @endif>1</option>
                                    <option value="2" @if((string) $jabatan->level === '2') selected @endif>2</option>
                                    <option value="3" @if((string) $jabatan->level === '3') selected @endif>3</option>
                                </select>
                                @error('level')
                                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                                @enderror
