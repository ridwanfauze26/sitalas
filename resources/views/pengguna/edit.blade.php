                ...
                <form action="{{route('pengguna.update', $pengguna->id)}}" method="POST">
                    ...
                    <div class="form-body">
                        <div class="form-group row">
                            <label class="control-label text-left col-md-3">NIP/NIK</label>
                            <div class="col-md-9">
                            <input type="text" name="nip" value="{{ $pengguna->nip }}" class="form-control @error('nip') is-invalid @enderror" required {{$readonly}}>
                            @error('nip')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                            <input type="text" name="name" value="{{ $pengguna->name }}" class="form-control @error('name') is-invalid @enderror" required {{$readonly}}>
                            @error('name')
                                <div class="alert alert-danger mt-1">{{ $message }}</div>
                            @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control custom-select select2" name="role" required>
                                    ...
                                    <option value="kepala" @if($pengguna->role  == "kepala") selected="selected" @endif>Kepala</option>
                                    <option value="verifikator" @if($pengguna->role  == "verifikator") selected="selected" @endif>Verifikator</option>
