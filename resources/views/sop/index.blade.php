            ...
            <div class="card-body">
                <h6 class="card-subtitle">
                    ...
                    @if (Auth::user()->role == 'admin'|| Auth::user()->role == 'verifikator')
                        <a class="btn btn-primary m-1" href="{{route('sop.create')}}" role="button">Tambah SOP</a>
                        @endif
                    </div>
                </h6>

                <!-- Form Filter -->
                <form method="GET" action="{{ route('sop.index') }}" class="mb-4">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="detailModalLabel">Detail SOP</h5>
...
@push('js')
    ...
    function getSOP(id){
        ...
        berkas_scan.setAttribute("src", "{{url('/sop/view/')}}"+'/'+id+'?t='+new Date().getTime());
    }
    ...
    $(document).ready(function() {
        var table = $('#table').DataTable({
            ...
            columns: [
                ...
                {data: 'file_sop', name: 'file_sop', orderable: false, searchable: false},
