@extends('layouts.app')
@section('judul','Buat Surat Masuk')
@section('content')
<!-- ============================================================== -->
<!-- Start Page Content -->
<!-- ============================================================== -->
                ...
                <form action="{{route('surat-masuk.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        @if(isset($suratmasuk->nomor_agenda))
                            ...
                            @php 
                                $temp = explode('-',$suratmasuk->nomor_agenda);
                                
                                if(date('Y')>$temp[1])
                                    $nomoragenda = '1-'.date('Y');
                                else
                                    $nomoragenda = ++$temp[0].'-'.date('Y'); 
                            @endphp
                            @endif
                        @else
                            @php $nomoragenda = '1-'.date('Y'); @endphp
                        @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="date" class="form-control" name="tanggal_penerimaan" value="{{ old('tanggal_penerimaan', Carbon\Carbon::now()->format('Y-m-d'))}}" placeholder="hh/bb/tttt" required>
                            </div>
                        </div>
                        @endif
                        <div class="form-group row">
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-md-9">
                            <input name="sifat" list="sifat" value="{{ old('sifat') }}" class="form-control">
                            <datalist id="sifat">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="demo-checkbox">
                                    ...
                                    <label for="disposisi{{$p->id}}" class="mr-3">{{$p->name.' - '.$p->jabatan->nama}}</label><br/>
                                    @endforeach
                                </div>
                            </div>
                        </div>
